package com.example.guest.chitchat.util;
...
import com.example.guest.chitchat.adapters.UserViewHolder;
...
public abstract class FirebaseRecyclerAdapter<ViewHolder extends RecyclerView.ViewHolder, T>
    ...
    public abstract void onBindViewHolder(UserViewHolder holder, int position);
